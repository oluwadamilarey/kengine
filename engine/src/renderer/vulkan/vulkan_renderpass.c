...
void vulkan_renderpass_create(
    ...
    // TODO: add resolve attachment for MSAA
    // TODO: add input attachments if needed
    // TODO: add preserve attachments if needed
    // TODO: add dependencies if needed
    // TODO: handle multiple subpasses if needed
    // TODO: handle different load/store ops based on parameters
    // TODO: handle different formats based on parameters
    // TODO: handle different sample counts based on parameters
    ...
    // Attachment resolve multisampling color attachment(s) [MSAA not yet supported]
    subpass.pResolveAttachments = 0;

    // Attachments to preserve, not used in this subpass but should be preserved for later use
    subpass.preserveAttachmentCount = 0;
    subpass.pPreserveAttachments = 0;

    // Renderpass dependency, TODO: make this configurable later
...
b8 vulkan_renderpass_begin(
    ...
    render_pass_begin_info.renderArea.extent.width = (u32)renderpass->w;
    render_pass_begin_info.renderArea.extent.height = (u32)renderpass->h;
