...
/**
 * @brief checks if a path with the given file exists
 *
 ...
 * @param node Mode flags for the file when opened (read/write). see file_modes enum in filesystem.h
 * @param binary Indicates if the file should be opened in binary node
